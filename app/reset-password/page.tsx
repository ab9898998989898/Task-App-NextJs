...
export default function ResetPasswordPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#0F172A] flex items-center justify-center px-4 py-12">
        ...
        >
          <div className="w-20 h-20 bg-gradient-to-br from-[#34D399] to-[#22D3EE] rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-[#34D399]/50">
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-[#3B82F6] to-[#22D3EE] rounded-3xl blur-xl opacity-20" />
