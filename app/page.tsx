        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-r from-[#3B82F6] to-[#22D3EE] rounded-3xl blur-2xl opacity-50"></div>
              <div className="relative w-20 h-20 bg-linear-to-br from-[#3B82F6] to-[#22D3EE] rounded-3xl flex items-center justify-center shadow-2xl shadow-[#3B82F6]/50">
          ...
          >
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="bg-linear-to-r from-[#3B82F6] via-[#22D3EE] to-[#3B82F6] bg-clip-text text-transparent animate-gradient">
                Manage Your Tasks
              </span>
              <br />
          ...
          >
            <Link href="/signup">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-8 py-4 bg-linear-to-r from-[#3B82F6] to-[#22D3EE] text-white font-semibold rounded-xl shadow-lg shadow-[#3B82F6]/50 transition-all duration-300 overflow-hidden"
              >
          ...
          >
            ...
            >
              <div className="w-12 h-12 bg-linear-to-br from-[#3B82F6] to-[#22D3EE] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            >
              <div className="w-12 h-12 bg-linear-to-br from-[#22D3EE] to-[#34D399] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="w-12 h-12 bg-linear-to-br from-[#34D399] to-[#3B82F6] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
